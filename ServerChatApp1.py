...
def initialize_server():
    ...
    '''Initiaze Socket'''
    host = '192.168.1.123' #to use betn devices in the same network eg:192.168.1.5
...
def GUI():
    ...
    '''⬆️ WE HAVE MADE CHATLOG.CONFIG(STATE=DISABLED)=SO THAT USER CANNOT MODIFY CHATLOG IT IS ONLY FOR DISPLAY PURPOSE'''
